...
public class RpistBaseStationClient extends RpistClient {
    ...
    private void setFakeNodes() {
        rpists.putIfAbsent("Room 1", new RpistNode(70, TemperatureScale.CELSIUS, "Room 1"));
        rpists.putIfAbsent("Room 2", new RpistNode(40, TemperatureScale.CELSIUS, "Room 2"));
        rpists.putIfAbsent("Room 3", new RpistNode(50, TemperatureScale.CELSIUS, "Room 3"));
