...
public class LocalStorage {
    ...
    public static int getInt(int resource_id, int default_value) {
        int value = sharedPref.getInt(context.getResources().getResourceEntryName(resource_id),
                default_value);
    ...
    public static String getString(int resource_id, String default_value) {
        String value = sharedPref.getString(context.getResources().getResourceEntryName
                (resource_id), default_value);
